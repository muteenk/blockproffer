  ...
  return (
    ...
    <div className='bg-gray-900 flex flex-col items-center justify-center'>
      <form onSubmit={sendRoomReq}>
        {(roomNotFound === true) ? <><div id="alert-border-2" className="flex p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50 dark:text-red-400 dark:bg-gray-800 dark:border-red-800" role="alert">
